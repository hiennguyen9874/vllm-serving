...
export TOKENIZER_MODEL="${TOKENIZER_MODEL:-Qwen/Qwen3.5-9B}"
export HF_CONFIG_PATH="${HF_CONFIG_PATH:-Qwen/Qwen3.5-9B}"
...
export GPU_MEMORY_UTILIZATION="${GPU_MEMORY_UTILIZATION:-0.3}" # Pre-allocate more KV to reduce preemption
