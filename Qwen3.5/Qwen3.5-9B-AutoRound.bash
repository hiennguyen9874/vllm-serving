#!/usr/bin/env bash
# ========================================================================================
# Qwen3.5-35B-A3B-AWQ on vLLM (V1 engine) - A100 40GB optimized launcher
# ========================================================================================
...
# --- Model & naming ---------------------------------------------------------------------
export MODEL_NAME="${MODEL_NAME:-kaitchup/Qwen3.5-9B-autoround-W4A16}"
export SERVED_MODEL_NAME="${SERVED_MODEL_NAME:-Qwen3.5-9B}"
export TOKENIZER_MODEL="${TOKENIZER_MODEL:-kaitchup/Qwen3.5-9B-autoround-W4A16}"
export HF_CONFIG_PATH="${HF_CONFIG_PATH:-kaitchup/Qwen3.5-9B-autoround-W4A16}"
...
PROFILE="${PROFILE:-LONG_CONTEXT}"   # THROUGHPUT | LOW_LATENCY | LONG_CONTEXT

case "$PROFILE" in
  THROUGHPUT)
    MAX_NUM_SEQS="${MAX_NUM_SEQS:-4}"          # NVIDIA model card suggests starting at 64
...
export GPU_MEMORY_UTILIZATION="${GPU_MEMORY_UTILIZATION:-0.375}" # Pre-allocate more KV to reduce preemption
