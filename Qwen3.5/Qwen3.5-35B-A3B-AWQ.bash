...
# --- Model & naming ---------------------------------------------------------------------
export MODEL_NAME="${MODEL_NAME:-QuantTrio/Qwen3.5-35B-A3B-AWQ}"
...
# Fix undefined symbol: __nvJitLinkGetErrorLogSize_12_9, version libnvJitLink.so.12
export LD_LIBRARY_PATH=/home/jovyan/workspace/llm-serving/vllm-serving/.venv/lib/python3.12/site-packages/nvidia/nvjitlink/lib:$LD_LIBRARY_PATH
